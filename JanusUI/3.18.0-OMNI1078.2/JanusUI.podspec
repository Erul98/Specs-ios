Pod::Spec.new do |s|
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/127056464',
                           :type => 'zip',
                           :headers => [
    ...
    s.dependency 'TekAutomationTestContract', '~> 0.1.0-OMNI1078'
